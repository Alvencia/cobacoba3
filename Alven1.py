...
import ALVENCIA
import requests
from ALVENCIA.lib.curve.ttypes import *
...
admin=["cb971971e0e5a3181ce684a2f31e117d3"]
creator=["cb971971e0e5a3181ce684a2f31e117d3"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~deadscreamer",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~deadscreamer",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "cb971971e0e5a3181ce684a2f31e117d3"}
					cl.sendMessage(msg)
